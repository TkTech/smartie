...
DRIVE_DATABASE = [
    ...
    DriveEntry(
        ...
        smart_attributes={
            ...
            0x05: SMARTAttribute('REALLOCATED_SECTORS_COUNT', 0x05,
                                 unit=Units.COUNT),
            ...
            0x0B: SMARTAttribute('RECALIBRATION_RETRIES', 0x0B,
                                 unit=Units.COUNT),
            0x0C: SMARTAttribute('POWER_CYCLE_COUNT', 0x0C, unit=Units.COUNT),
            0x0D: SMARTAttribute('SOFT_READ_ERROR_RATE', 0x0D,
                                 unit=Units.COUNT),
            0x16: SMARTAttribute('CURRENT_HELIUM_LEVEL', 0x16),
            # TODO: See E8
            0xAA: SMARTAttribute('AVAILABLE_RESERVED_SPACE', 0xAA),
            0xAB: SMARTAttribute('SSD_PROGRAM_FAIL_COUNT', 0xAB,
                                 unit=Units.COUNT),
            0xAC: SMARTAttribute('SSD_ERASE_FAIL_COUNT', 0xAC,
                                 unit=Units.COUNT),
            0xAD: SMARTAttribute('SSD_WEAR_LEVELING_COUNT', 0xAD,
                                 unit=Units.COUNT),
            ...
            0xB2: SMARTAttribute('USED_RESERVED_BLOCK_COUNT', 0xB2,
                                 unit=Units.COUNT),
            0xB3: SMARTAttribute('USED_RESERVED_BLOCK_COUNT_TOTAL', 0xB3,
                                 unit=Units.COUNT),
            0xB4: SMARTAttribute(
            ...
            0xB5: SMARTAttribute('PROGRAM_FAIL_COUNT_TOTAL', 0xB5,
                                 unit=Units.COUNT),
            ...
            0xBB: SMARTAttribute('REPORTED_UNCORRECTABLE_ERRORS', 0xBB,
                                 unit=Units.COUNT),
            ...
            0xC0: SMARTAttribute('UNSAFE_SHUTDOWN_COUNT', 0xC0,
                                 unit=Units.COUNT),
            0xC1: SMARTAttribute('LOAD_CYCLE_COUNT', 0xC1, unit=Units.COUNT),
            0xC2: SMARTAttribute('TEMPERATURE_ABSOLUTE', 0xC2,
                                 unit=Units.CELSIUS),
            0xC3: SMARTAttribute('HARDWARE_ECC_RECOVERED', 0xC3),
            0xC4: SMARTAttribute('REALLOCATION_EVENT_COUNT', 0xC4,
                                 unit=Units.COUNT),
            0xC5: SMARTAttribute('CURRENT_PENDING_SECTOR_COUNT', 0xC5,
                                 unit=Units.COUNT),
            0xC6: SMARTAttribute('UNCORRECTABLE_SECTOR_COUNT', 0xC6,
                                 unit=Units.COUNT),
            0xC7: SMARTAttribute('ULTRA_DMA_CRC_ERROR_COUNT', 0xC7,
                                 unit=Units.COUNT),
            0xC8: SMARTAttribute('WRITE_ERROR_RATE', 0xC8, unit=Units.COUNT),
            0xC9: SMARTAttribute('SOFT_READ_ERROR_RATE', 0xC9,
                                 unit=Units.COUNT),
            ...
            0xCD: SMARTAttribute('THERMAL_ASPERITY_RATE', 0xCD,
                                 unit=Units.COUNT),
            ...
            0xDF: SMARTAttribute('LOAD_UNLOAD_RETRY_COUNT', 0xDF,
                                 unit=Units.COUNT),
            0xE0: SMARTAttribute('LOAD_FRICTION', 0xE0),
            0xE1: SMARTAttribute('LOAD_UNLOAD_CYCLE_COUNT', 0xE1,
                                 unit=Units.COUNT),
            0xE2: SMARTAttribute('LOAD_IN_TIME', 0xE2),
            0xE3: SMARTAttribute('TORQUE_AMPLIFICATION_COUNT', 0xE3,
                                 unit=Units.COUNT),
            0xE4: SMARTAttribute('POWER_OFF_RETRACT_CYCLE', 0xE4,
                                 unit=Units.COUNT),
            ...
            0xFA: SMARTAttribute('READ_ERROR_RETRY_RATE', 0xFA,
                                 unit=Units.COUNT),
